    ...
    var renderTable = function () {
        ...
        if (isBasic) {
            thead = ` <thead>
                      ...
                      <th class="mdc-data-table__header-cell">学号</th>
                      <th class="mdc-data-table__header-cell">姓名</th>
                      <th class="mdc-data-table__header-cell">专业</th>
                      <th class="mdc-data-table__header-cell">邮箱</th>
                      <th class="mdc-data-table__header-cell">电话号码</th>
                      <th class="mdc-data-table__header-cell">qq</th>
                      <th class="mdc-data-table__header-cell">状态</th>
                      <th class="mdc-data-table__header-cell">报名部门</th>
                      <th class="mdc-data-table__header-cell">个人简介</th>
                      </tr>
                      </thead>`
